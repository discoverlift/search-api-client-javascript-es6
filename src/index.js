...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Document', 'model/FacetParams', 'model/FacetResponse', 'model/FacetResponseValues', 'model/FetchParams', 'model/FetchRequest', 'model/FetchResponse', 'model/HighlightResponse', 'model/PaginationParams', 'model/PersonalizationParams', 'model/QueryPerformance', 'model/RankingParams', 'model/RequestParams', 'model/SearchHighlightParams', 'model/SearchParams', 'model/SearchRequest', 'model/SearchResponse', 'model/SuggestHighlightParams', 'model/SuggestParams', 'model/SuggestParamsSuggestionSource', 'model/SuggestRequest', 'model/SuggestResponse', 'api/FetchApi', 'api/SearchApi', 'api/SuggestApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Document'), require('./model/FacetParams'), require('./model/FacetResponse'), require('./model/FacetResponseValues'), require('./model/FetchParams'), require('./model/FetchRequest'), require('./model/FetchResponse'), require('./model/HighlightResponse'), require('./model/PaginationParams'), require('./model/PersonalizationParams'), require('./model/QueryPerformance'), require('./model/RankingParams'), require('./model/RequestParams'), require('./model/SearchHighlightParams'), require('./model/SearchParams'), require('./model/SearchRequest'), require('./model/SearchResponse'), require('./model/SuggestHighlightParams'), require('./model/SuggestParams'), require('./model/SuggestParamsSuggestionSource'), require('./model/SuggestRequest'), require('./model/SuggestResponse'), require('./api/FetchApi'), require('./api/SearchApi'), require('./api/SuggestApi'));
  }
}(function(ApiClient, Document, FacetParams, FacetResponse, FacetResponseValues, FetchParams, FetchRequest, FetchResponse, HighlightResponse, PaginationParams, PersonalizationParams, QueryPerformance, RankingParams, RequestParams, SearchHighlightParams, SearchParams, SearchRequest, SearchResponse, SuggestHighlightParams, SuggestParams, SuggestParamsSuggestionSource, SuggestRequest, SuggestResponse, FetchApi, SearchApi, SuggestApi) {
  'use strict';
