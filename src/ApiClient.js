...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.UpliftCatalogClientJavascript.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.prod.discoverlift.com/catalog-api
     */
    this.basePath = 'https://api.prod.discoverlift.com/catalog-api'.replace(/\/+$/, '');
  ...
  /**
    ...
    */
    exports.hostSettings = function() {
        return [
            {
              'url': "https://api.prod.discoverlift.com/catalog-api",
